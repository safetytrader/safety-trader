...
export default function App() {
  ...
  if (page === "dashboard") return (
    <div className="min-h-screen bg-slate-50">
      <AppHeader user={user} right={<button onClick={() => { setNewCantiere({ nome: "", indirizzo: "", cse: user.ruolo === "CSE" ? `${user.nome} ${user.cognome}` : "", dataInizio: "" }); setShowNewCantiere(true); }} className="bg-blue-500 hover:bg-blue-400 text-white text-sm px-4 py-2 rounded-lg font-medium transition">+ Nuovo cantiere</button>} />
